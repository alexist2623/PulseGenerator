...
@pytest.mark.parametrize('policy', ['preserve', 'coherent_average'])
def test_qcodes_roundtrip_preserves_low_bits_even_when_averaging(tmp_path, monkeypatch, policy):
    ...
    dataset,_=store_qick_result(result,run_config=QcodesRunConfig(str(tmp_path/'iq64.db')),
        ...
        program_summary={},gui_settings={},rf_settings={},iq_repetition_policy=policy)
